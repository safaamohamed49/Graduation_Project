...
<template>
  <EntityFormShell
    page-title="إضافة عميل"
    hero-badge="العملاء / إضافة"
    hero-title="إضافة عميل جديد"
    hero-description="أدخلي بيانات العميل بشكل واضح ومنظم داخل النظام."
    hero-back-href="/customers"
    hero-gradient-class="bg-gradient-to-l from-blue-700 via-blue-600 to-sky-500"
  ...
  >
    <div class="grid gap-5 p-6 md:grid-cols-2">
      ...
      <div>
        <label class="mb-2 block text-sm font-black text-slate-700">الهاتف</label>
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        ...
        <BaseButton label="حفظ العميل" color="primary" type="submit" :disabled="form.processing" />
      </div>
    </template>
  </EntityFormShell>
</template>